...
public class Image_Buller extends JFrame{
    ...
    {
String Select_image= JOptionPane.showInputDialog("Enter File");
        Color color[];
  
        File Selecting = new File(Select_image);
  
        BufferedImage inputimage = ImageIO.read(Selecting);
  ...
  JOptionPane.showMessageDialog(null, "Please Wait.....");
        ...
        for (x = radius; x < inputimage.getHeight() - radius; x++) {
            for (y = radius; y < inputimage.getWidth() - radius; y++) {
        ...
        ImageIO.write(
            outputimage, "jpg",
            new File("E:/Bullerd_Image3.jpg"));
	
			
        JOptionPane.showMessageDialog(null,"Blurred Succss Thank You...!");
